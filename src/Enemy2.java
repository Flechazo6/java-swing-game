...
public class Enemy2 extends Enemy{
    ...
    public Enemy2(MyPanel myPanel) {
        ...
        this.image = Toolkit.getDefaultToolkit().getImage("enemy2.png");

    }

    //敌机爆炸效果，放在放到数组中
    public Image[] dieImages = new Image[] {
            Toolkit.getDefaultToolkit().getImage("enemy2_down1.png"),
            Toolkit.getDefaultToolkit().getImage("enemy2_down2.png"),
            Toolkit.getDefaultToolkit().getImage("enemy2_down3.png"),
            Toolkit.getDefaultToolkit().getImage("enemy2_down4.png"),
    };
